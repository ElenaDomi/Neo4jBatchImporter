...
/**
 * projectName: BatchImport<br>
 * desc: TODO<br>
 * date: Aug 18, 2014 2:00:57 PM<br>
 * @author 开发者真实姓名[HuPeng]
 */
public class ImporterTmp {
...
//	private final String ENTPRIPID = "node";
	...
	public ImporterTmp(File graphDb) {
	...
	public static void main(String[] args) throws IOException {
		...
		ImporterTmp importBatch = new ImporterTmp(graphDb);
	...
	private long id(Object id) {
		return nodeIndex.get("node", id).getSingle();
